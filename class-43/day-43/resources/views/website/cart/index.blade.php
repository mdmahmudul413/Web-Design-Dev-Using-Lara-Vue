...
@section('body')
    ...
    <div class="shopping-cart section">
        <div class="container">
            <h4 class="text-center text-success mb-2">{{session('message')}}</h4>
                ...
                @foreach($cart_products as $cart_product)
                    <div class="cart-single-list">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-md-3 col-12">
                                <h5 class="product-name"><a href="{{route('detail', ['id' => $cart_product->id])}}">
                            ...
                            <div class="col-lg-2 col-md-2 col-12">
                                <form action="{{route('cart.update', ['id' => $cart_product->id])}}" method="POST">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="quantity" min="1" value="{{$cart_product->quantity}}" class="form-control"/>
                    ...
                    <div class="total-amount">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart Subtotal (Tk)<span>{{$sum}}</span></li>
                                        <li>Tax Amount (Tk)<span>{{$tax = $sum * 0.15}}</span></li>
                                        <li>Shipping (Tk)<span>{{$shipping = 500}}</span></li>
                                        <li class="last">Total Payable (Tk)<span>{{$totalPayable = $sum + $tax + $shipping}}</span></li>
                                    </ul>
                                    <div class="button">
