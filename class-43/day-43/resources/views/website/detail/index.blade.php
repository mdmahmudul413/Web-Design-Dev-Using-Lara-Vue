                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="xzoom-container">
                            <img class="xzoom" id="xzoom-default" height="500" width="500" src="{{asset($product->image)}}" xoriginal="{{asset($product->image)}}"/>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category">
                                <i class="lni lni-tag"></i> Category:<a href="javascript:void(0)">{{$product->category->name}}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i> Sub Category:<a href="javascript:void(0)">{{$product->subCategory->name}}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i> Brand:<a href="javascript:void(0)">{{$product->brand->name}}</a>
                            </p>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <button type="submit" class="btn" style="width: 100%; z-index: 0;">Add to Cart</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
