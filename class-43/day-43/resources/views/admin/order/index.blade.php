                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.order-delete', ['id' => $order->id])}}" onclick="return confirm('Are you want to delete this order?')" class="btn btn-danger btn-sm {{$order->order_status == 'complete' || $order->order_status == 'pending' || $order->order_status == 'processing' ? 'disabled' : ''}}" title="Order Delete">
