                ...
                <div class="card-body">
                    ...
                    <form action="{{route('category.update', ['id' => $category->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input value="{{$category->name}}" type="text" class="form-control" id="horizontal-firstname-input" name="name"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img class="mt-3" src="{{asset($category->image)}}" alt="" height="100" width="130"/>
                            </div>
                        </div>
