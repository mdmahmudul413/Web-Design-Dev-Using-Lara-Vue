        ...
        <div class="container">
            <div class="cart-list-head">
                ...
                <div class="cart-single-list" v-for="(product, key) in products" :key="key">
                    <div class="row align-items-center">
                        <div class="col-lg-1 col-md-1 col-12">
                            <router-link :to="{name: 'detail', params:{id:product.id}}"><img :src="product.image" alt="#"></router-link>
                        </div>
                        <div class="col-lg-4 col-md-3 col-12">
                            <h5 class="product-name"><router-link :to="{name: 'detail', params:{id:product.id}}">
