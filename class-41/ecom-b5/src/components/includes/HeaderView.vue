                                ...
                                <ul class="sub-category">
                                    <li v-for="(category, index) in categories" :key="index">
                                        ...
                                        <ul class="inner-sub-category">
                                            <li v-for="(sub_category, key) in category.sub_categories" :key="key"><a href="#">{{sub_category.name}}</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get('http://localhost/Web-Design-Dev-Using-Lara-Vue/class-35/day-35/public/api/test').then( response => {
