                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset($cartItem->attributes->image)}}" alt="#"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="product-details.html">{{$cartItem->name}}</a></h4>
                                                <p class="quantity">{{$cartItem->quantity}} x <span class="amount">Tk. {{$cartItem->price}}</span></p>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
