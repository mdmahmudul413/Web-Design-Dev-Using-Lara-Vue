                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        ...
                                                        <span class="text-danger mt-1">{{$errors->has('email') ? $errors->first('email') : ''}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        ...
                                                        <span class="text-danger mt-1">{{$errors->has('mobile') ? $errors->first('mobile') : ''}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div>
                                                        <textarea name="delivery_address" class="form-control" cols="30" rows="5"></textarea>
                                                        <span class="text-danger mt-1">{{$errors->has('delivery_address') ? $errors->first('delivery_address') : ''}}</span>
                                                    </div>
                                                </div>
                                            </div>
