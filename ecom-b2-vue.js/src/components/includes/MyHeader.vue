                                ...
                                <div class="navbar-cart">
                                    ...
                                    <div class="cart-items">
                                        <a href="javascript:void(0)" class="main-btn">
                                            ...
                                            <span class="total-items"> {{totalCartProduct.length}} </span>
                                        </a>
                                            ...
                                            <ul class="shopping-list">
                                                <li>
                                                    ...
                                                    <div class="cart-img-head">
                                                        <a class="cart-img" href="product-details.html"><img src="/images/header/cart-items/item1.jpg" alt="#"></a>
                                                    </div>
                                                    <div class="content">
                                ...
                                <ul class="sub-category">
                                    <li v-for="(category, key) in categories" :key="key">
                                        <router-link :to="{name: 'category', params:{id: category.category.id}}">
                                            {{category.category.name}} <i class="lni lni-chevron-right" v-if="category.sub_category.length > 0"></i>
                                        </router-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            getAllCategory()
            {
                axios.get('http://localhost/ecommerce-b2/public/api/all-category').then((response) => {
            ...
            logout()
            {
                ...
                axios.post('http://localhost/ecommerce-b2/public/api/customer-logout', data).then((response) => {
