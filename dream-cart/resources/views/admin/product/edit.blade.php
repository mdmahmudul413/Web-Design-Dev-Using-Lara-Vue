                    ...
                    <div class="live-preview">
                        <form action="{{route('product.update', ['id' => $product->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9">
                                    <input value="{{$product->name}}" type="text" class="form-control" id="nameInput" name="name"/>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    <input value="{{$product->code}}" type="text" class="form-control" id="codeInput" name="code"/>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    <input value="{{$product->stock_amount}}" type="number" class="form-control" id="stockInput" name="stock_amount"/>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-lg-3">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <img class="mt-3" src="{{asset($product->image)}}" alt="Product Image" height="120" width="120"/>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    @foreach($product->otherImages as $otherImage)
                                        <img class="mt-3" src="{{asset($otherImage->image)}}" alt="Product Image" height="120" width="120"/>
                                    @endforeach
                                </div>
                            </div>
                            <div class="row mb-4">
