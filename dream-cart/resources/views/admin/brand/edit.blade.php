        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Brand</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{route('brand.update', ['id' => $brand->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" value="{{$brand->name}}" class="form-control" id="nameInput" name="name"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    <textarea class="form-control" id="descInput" rows="5" name="description">{{$brand->description}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <img class="mt-3" src="{{asset($brand->image)}}" alt="Category Image" height="100" width="180"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
