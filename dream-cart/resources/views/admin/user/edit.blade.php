                    ...
                    <div class="live-preview">
                        <form action="{{route('user.update', ['id' => $user->id])}}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    <input value="{{$user->name}}" type="text" class="form-control" id="nameInput" name="name"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    <input value="{{$user->email}}" type="email" class="form-control" id="emailInput" name="email"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
                                    <label for="passInput" class="form-label mb-0 text-danger">User Password</label><br>
                                </div>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="passInput" placeholder="If you want to change the user password, then fill it. Otherwise skip this field." name="password"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3">
