    ...
    <main class="main">
        ...
        <div class="page-header" style="height: 250px">
            <div class="container">
                ...
                <p style="font-size: 16px;" class="greeting">
                    Hello,
                    <span class="text-dark font-weight-bold">{{session('customer_name')}}</span>
                    (not
                    <span class="text-dark font-weight-bold">{{session('customer_name')}}</span>?
        ...
        <div class="page-content pt-2">
            <div class="container">
                <div class="tab tab-vertical row gutter-lg">
                    <ul class="nav nav-tabs mb-6" role="tablist" style="margin-top: 50px; border: 2px solid #eaeaea; margin-right: inherit">
                    ...
                    <div class="tab-content mb-6" style="margin-top: 50px; border: 2px solid #eaeaea">
                        <div class="tab-pane active in" id="account-dashboard">
                            <div class="icon-box-side mb-5" style="display: flex;justify-content: flex-start;">
                                    <span class="icon-box-icon icon-orders">
                                        <i class="w-icon-dashboard"></i>
                                    </span>
                                <div class="icon-box-content">
                                    <h4 style="font-size: 16px;" class="icon-box-title text-capitalize ls-normal mb-0">Dashboard</h4>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="tab-pane mb-4" id="account-orders">
                            <div class="icon-box icon-box-side icon-box-light mt-3 mb-5" style="display: flex;justify-content: flex-start;">
                                    <span class="icon-box-icon icon-orders">
                                        <i class="w-icon-orders"></i>
                                    </span>
                                <div class="icon-box-content">
                                    <h4 style="font-size: 16px;" class="icon-box-title text-capitalize ls-normal mb-0">Orders</h4>
                                </div>
                            </div>
                            ...
                            <table class="shop-table account-orders-table mb-6">
                                <thead>
                                <tr>
                                    <th style="text-align: start;">SL No</th>
                                    <th style="text-align: start;">Order Id</th>
                                    <th style="text-align: start;">Order Total (Tk)</th>
                                ...
                                <tr>
                                    <td class="order-id">{{$loop->iteration}}</td>
                                    <td class="order-date">{{$order->id}}</td>
                                    <td class="order-status">{{$order->order_total}}</td>
                                    <td class="order-total">{{$order->order_date}}</td>
                                    <td class="order-total">{{$order->order_status}}</td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="tab-pane" id="account-addresses">
                            <div class="icon-box icon-box-side icon-box-light mt-3 mb-5" style="display: flex;justify-content: flex-start;">
                                ...
                                <div class="icon-box-content">
                                    <h4 style="font-size: 16px;" class="icon-box-title text-capitalize ls-normal mb-0">Addresses</h4>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="account-details">
                            <div class="icon-box icon-box-side icon-box-light mt-3 mb-5" style="display: flex;justify-content: flex-start;">
                                ...
                                <div class="icon-box-content">
                                    <h4 style="font-size: 16px;" class="icon-box-title text-capitalize ls-normal mb-0">Account Details</h4>
                                </div>
                            </div>
