...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $this->orderId = Order::orderBy('id', 'desc')->first()->id;
        $this->orderDetail = OrderDetail::newOrderDetail($this->orderId);
    ...
    public function success(Request $request)
    {
        ...
        $order_details = DB::table('orders')
            ...
            ->select('transaction_id', 'order_status', 'currency', 'order_total', 'customer_id')->first();
